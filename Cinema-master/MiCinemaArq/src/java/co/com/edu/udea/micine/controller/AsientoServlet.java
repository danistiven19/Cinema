...
public class AsientoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String localidad = Integer.toString(f.getTarifa().getLocalidad().getIdLocalidad());
        if(f == null){
        ...
        List<co.com.edu.udea.micine.model.Asiento> listAs = iAsiento.obtenerAsientoPorSala(f.getSala().getId());
        ...
        if(localidad != null && !localidad.equals("")){
            ...
            List<co.com.edu.udea.micine.model.Asiento> def = new ArrayList<co.com.edu.udea.micine.model.Asiento>();
            Iterator it = listAs.iterator();
            while(it.hasNext()){
                co.com.edu.udea.micine.model.Asiento as = (co.com.edu.udea.micine.model.Asiento) it.next();
