...
-- -----------------------------------------------------
-- Table `miCinemaArq`.`Cartelera`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `miCinemaArq`.`Cartelera` (
  `idCartelera` INT NOT NULL,
  `Cine_idCine` INT NOT NULL,
  `FechaCreacion` DATE NULL,
  PRIMARY KEY (`idCartelera`, `Cine_idCine`),
  INDEX `fk_Cartelera_Cine1_idx` (`Cine_idCine` ASC),
...
CREATE TABLE IF NOT EXISTS `miCinemaArq`.`Funcion` (
  ...
  INDEX `fk_Funcion_Cartelera1_idx` (`Cartelera_idCartelera` ASC),
  ...
  CONSTRAINT `fk_Funcion_Sala1`
    ...
    REFERENCES `miCinemaArq`.`Sala` (`idSala`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Funcion_Cartelera1`
    FOREIGN KEY (`Cartelera_idCartelera`)
    REFERENCES `miCinemaArq`.`Cartelera` (`idCartelera`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `miCinemaArq`.`Genero_has_Genero`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `miCinemaArq`.`Genero_has_Genero` (
  `Genero_idGenero` INT NOT NULL,
  `Genero_idGenero1` INT NOT NULL,
  PRIMARY KEY (`Genero_idGenero`, `Genero_idGenero1`))
ENGINE = InnoDB;
